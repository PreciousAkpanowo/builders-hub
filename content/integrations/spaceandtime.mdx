...
description: "Space and Time is the blockchain for ZK-proven data."
...
## Overview
Space and Time is the blockchain for ZK-proven data, offering data indexing services across major chains like Bitcoin, Avalanche, Ethereum, ZKSync, and Polygon. It scales zero-knowledge (ZK) proofs on a decentralized data warehouse to deliver trustless, verifiable data processing directly to smart contracts. With SXT, you can join rich, indexed blockchain data with your application’s data or other offchain datasets to power advanced analytics and decentralized applications.
